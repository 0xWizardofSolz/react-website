...
const HeroSection = memo(() => (
  <Section id="home" className="py-12 md:py-24">
    <SectionCard className="max-w-3xl">
      <h2 className="text-xl md:text-2xl text-green-600 dark:text-green-300 font-mono mb-2 text-center">Melvin Ragusa | Inhaber & Webentwickler</h2>
      ...
      <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-8 text-center">
        Ich entwickle maßgeschneiderte Web-Applikationen mit React & Tailwind CSS und erstelle performante Shopify Stores, die Ihre Marke perfekt repräsentieren und Ihre Geschäftsprozesse optimieren.
      </p>
