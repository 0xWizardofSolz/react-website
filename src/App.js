...
export default function App() {
  ...
  return (
    <div className="bg-gray-900 text-gray-300 font-sans leading-relaxed tracking-wide bg-grid">
      <Header />
  ...
  <header className="bg-gray-900/70 backdrop-blur-sm sticky top-0 z-40 border-b border-green-900/30">
    <div className="container mx-auto flex items-center justify-between p-4 text-white">
      ...
      <nav className="hidden md:flex items-center space-x-6">
        ...
        <a href="#contact" className="bg-green-500 hover:bg-green-600 text-gray-900 font-bold py-2 px-4 rounded-md text-sm transition-all duration-300">Contact</a>
      </nav>
    </div>
  </header>
);
...
const HeroSection = () => (
  <section id="home" className="text-center py-20 md:py-32">
     <h2 className="text-xl md:text-2xl text-green-400 font-mono mb-2">Melvin Ragusa | Inhaber & IT-Consultant</h2>
    ...
    <a
      href="#portfolio"
      className="bg-green-500 hover:bg-green-600 text-gray-900 font-bold py-3 px-8 rounded-full text-lg transition-transform transform hover:scale-105 duration-300 inline-block shadow-lg shadow-green-500/20"
    >
      View My Work
    </a>
  </section>
...
const AboutSection = () => (
    <section id="about" className="py-20 flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/3 text-center md:text-left">
             <div className="w-48 h-48 mx-auto md:mx-0 rounded-full bg-gray-800 border-2 border-green-500 p-2 mb-4">
                 <img src="https://placehold.co/192x192/1A202C/38A169?text=MR" alt="Melvin Ragusa" className="rounded-full w-full h-full object-cover" />
             </div>
        ...
        <section id="services" className="py-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {services.map((service, index) => (
                    <div key={index} className="bg-gray-800/50 backdrop-blur-sm border border-green-900/30 p-8 rounded-lg shadow-lg hover:shadow-green-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center">
                        {service.icon}
...
const PortfolioSection = () => {
    const projects = [
        {
            ...
            imgSrc: "https://placehold.co/600x400/1A202C/38A169?text=Project+1",
        ...
        },
        {
            ...
            imgSrc: "https://placehold.co/600x400/1A202C/38A169?text=Project+2",
        ...
        },
        {
            ...
            imgSrc: "https://placehold.co/600x400/1A202C/38A169?text=Project+3",
    ...
    return (
        <section id="portfolio" className="py-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {projects.map(p => (
                    <div key={p.title} className="bg-gray-800/50 backdrop-blur-sm border border-green-900/30 rounded-lg overflow-hidden group">
    ...
    return (
        <section id="testimonials" className="py-20">
            ...
            <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-8">
                {testimonials.map(t => (
                     <div key={t.name} className="bg-gray-800/50 backdrop-blur-sm border border-green-900/30 p-6 rounded-lg">
                        <p className="text-gray-300 italic">"{t.quote}"</p>
                        <p className="text-right mt-4 font-bold text-green-400">- {t.name}, <span className="text-gray-500 font-normal">{t.company}</span></p>
                    </div>
                ))}
            </div>
        </section>
...
const ContactSection = ({ formData, handleInputChange }) => (
  <section id="contact" className="py-20">
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm border border-green-900/30 p-8 rounded-lg shadow-2xl shadow-green-900/10">
        {/* This form is now set up for Netlify */}
        <form name="contact" method="POST" data-netlify="true">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input type="text" id="name" name="name" value={formData.name} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 rounded-md py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" required />
            </div>
            <div>
              <label htmlFor="email" className="block text-gray-400 mb-2 font-mono text-sm">Email</label>
              <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 rounded-md py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" required />
            </div>
          </div>
          <div className="mb-6">
            <label htmlFor="message" className="block text-gray-400 mb-2 font-mono text-sm">Message</label>
            <textarea id="message" name="message" rows="5" value={formData.message} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 rounded-md py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" required></textarea>
          </div>
          <div className="text-center">
            <button type="submit" className="bg-green-500 hover:bg-green-600 text-gray-900 font-bold py-3 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-green-500/20">
              Send Message
            </button>
          </div>
        </form>
...
const Footer = ({ onImpressumClick }) => (
  <footer className="bg-gray-900 border-t border-green-900/30">
...
const ImpressumModal = ({ onClose }) => (
  <div className="fixed inset-0 bg-black bg-opacity-80 backdrop-blur-sm z-50 flex justify-center items-center p-4">
    <div className="bg-gray-800 rounded-lg shadow-2xl max-w-2xl w-full max-h-full overflow-y-auto p-8 relative border border-green-700">
      ...
      <div className="text-gray-300 space-y-4 font-mono text-sm">
        ...
        Melvin Ragusa<br />
        Musterstraße 123 <span className="text-gray-500 italic">(Placeholder)</span><br />
        12345 Musterstadt <span className="text-gray-500 italic">(Placeholder)</span><br />
        Germany</p>
        ...
        DE123456789 <span className="text-gray-500 italic">(Placeholder)</span></p>
...
const StyleInjector = () => {
    const styles = `
        ...
        .bg-grid::before {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at center, transparent, #111827 80%);
            pointer-events: none;
        }
    `;
